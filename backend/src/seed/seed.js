...
async function seed() {
  ...
  const users = await User.bulkCreate([
    ...
    },
    {
      ...
      full_name: "Trần Thị Giao Dịch",
      email: "teller1@viettrustbank.vn",
      phone: "0901000002",
      address: "Hà Nội",
      role: "TELLER",
      status: "ACTIVE",
    },
    {
      ...
      full_name: "Lê Văn Thẩm Định",
      email: "loanofficer1@viettrustbank.vn",
      phone: "0901000003",
      address: "Hà Nội",
      role: "LOAN_OFFICER",
      status: "ACTIVE",
    },
    {
      ...
      email: "manager1@viettrustbank.vn",
      phone: "0901000004",
      address: "Hà Nội",
      role: "MANAGER",
      status: "ACTIVE",
